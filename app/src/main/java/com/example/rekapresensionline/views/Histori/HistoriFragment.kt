...
import com.example.rekapresensionline.model.Histori
import com.example.rekapresensionline.model.HistoriResponse
import com.example.rekapresensionline.networking.ApiServices
import com.example.rekapresensionline.tanggal.MyDate.fromTimeStampToDate
import com.example.rekapresensionline.tanggal.MyDate.toCalendar
import com.example.rekapresensionline.tanggal.MyDate.toDate
import com.example.rekapresensionline.tanggal.MyDate.toDay
import com.example.rekapresensionline.tanggal.MyDate.toMonth
import com.example.rekapresensionline.tanggal.MyDate.toTime
...
class HistoriFragment : Fragment() {
    ...
    private companion object{
        private val TAG: String = HistoriFragment::class.java.simpleName
    }

    private var binding: FragmentHistoriBinding? = null
    private val events = mutableListOf<EventDay>()
    private var dataHistories: List<Histori?>? = null
    ...
    private fun requestDataHistori() {
        ...
        getDataHistori(fromDate, toDate)
    }

    private fun getDataHistori(fromDate: String, toDate: String) {
        val token = HawkStorage.instance(context).getToken()
        binding?.pbHistori?.visibility = View.VISIBLE
        ApiServices.getPresensiServices()
            ...
            .enqueue(object : Callback<HistoriResponse> {
                override fun onResponse(
                    ...
                    binding?.pbHistori?.visibility = View.GONE
